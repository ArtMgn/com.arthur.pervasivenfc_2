...
public class WriteFacebook extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_facebook);
	...
	private void write(String text, Tag tag) throws IOException, FormatException {
		...
		NdefRecord[] records = {  createWellKnownRecord(text2), createMimeRecord("0/fac/" + text) };
