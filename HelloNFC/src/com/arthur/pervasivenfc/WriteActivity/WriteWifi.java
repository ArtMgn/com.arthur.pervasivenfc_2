 ...
 */
package com.arthur.pervasivenfc.WriteActivity;
...
public class WriteWifi extends Activity {
			...
			public void onClick(View v) {
				try {
					if(mytag==null){
						...
						String strssid = ssid.getText().toString();
						String strpassword = password.getText().toString();
						
						final String contact = strssid + ":" + strpassword;
						write(contact, mytag);
	...
	private void write(String text, Tag tag) throws IOException, FormatException {
		...
		NdefRecord[] records = {  createWellKnownRecord(text2), createMimeRecord("0/w/" + text) };
